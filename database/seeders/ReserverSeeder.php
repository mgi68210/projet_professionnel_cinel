...
use Illuminate\Database\Seeder;            // Pour créer un Seeder
use Illuminate\Support\Facades\DB;         // Pour accéder à la base de données
use Carbon\Carbon;                         // Pour gérer les dates (ex: maintenant)
...
class ReserverSeeder extends Seeder
{
    public function run(): void
    {
        ...
        //  À la fin, toutes les réservations sont enregistrées automatiquement
    }
}
